...
createPageHeader("Update The Acoount","");
//displayLogo();
...
if (isset($_POST['submit'])){
    ...
    if ( $fnameerr == " " && $lnameerr == " " && $addresserr == " " && $cityerr == " " && $provinceerr == " " && $postalCodeerr == " " && $usernameerr == " " && $passworderr == " ") {
        $update=$customer->update($_SESSION['User']);
...
<tr>
<td><input  type="submit" name="submit" value='Update' style="font-size:14pt;font-weight:italic;float:center; color:green;" > </td>	
